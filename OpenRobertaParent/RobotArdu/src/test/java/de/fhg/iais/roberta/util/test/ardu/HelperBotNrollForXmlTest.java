    ...
    public HelperBotNrollForXmlTest() {
        super(
            ...
            new BotNrollConfiguration.Builder()
                .addActor(new ActorPort("A", "A"), new Actor(ActorType.LARGE, true, DriveDirection.FOREWARD, MotorSide.NONE))
                .addActor(new ActorPort("B", "B"), new Actor(ActorType.MEDIUM, true, DriveDirection.FOREWARD, MotorSide.LEFT))
                .addActor(new ActorPort("C", "C"), new Actor(ActorType.LARGE, false, DriveDirection.FOREWARD, MotorSide.RIGHT))
                .addActor(new ActorPort("D", "D"), new Actor(ActorType.MEDIUM, false, DriveDirection.FOREWARD, MotorSide.NONE))
                .build());
