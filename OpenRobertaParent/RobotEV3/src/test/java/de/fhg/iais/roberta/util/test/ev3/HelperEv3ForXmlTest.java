    ...
    public HelperEv3ForXmlTest() {
        super(
            ...
            new EV3Configuration.Builder()
                ...
                .addActor(new ActorPort("B", "B"), new Actor(ActorType.MEDIUM, true, DriveDirection.FOREWARD, MotorSide.RIGHT))
                .addActor(new ActorPort("C", "C"), new Actor(ActorType.LARGE, false, DriveDirection.FOREWARD, MotorSide.LEFT))
                .addActor(new ActorPort("D", "D"), new Actor(ActorType.MEDIUM, false, DriveDirection.FOREWARD, MotorSide.RIGHT))
                .build());
