...
public class SimulationVisitor extends RobotSimulationVisitor<Void> {
    ...
    public Void visitMotorGetPowerAction(MotorGetPowerAction<Void> motorGetPowerAction) {
        this.sb.append("createGetMotorPower(" + (motorGetPowerAction.getPort().getPortName().equals("B") ? MOTOR_RIGHT : MOTOR_LEFT).toString() + ")");
        return null;
    }
    ...
    public Void visitMotorOnAction(MotorOnAction<Void> motorOnAction) {
        ...
        this.sb.append(", " + (motorOnAction.getPort().getPortName().equals("B") ? MOTOR_RIGHT : MOTOR_LEFT).toString());
        if ( isDuration ) {
    ...
    public Void visitMotorSetPowerAction(MotorSetPowerAction<Void> motorSetPowerAction) {
        String end = createClosingBracket();
        this.sb.append("createSetMotorPowerAction(" + (motorSetPowerAction.getPort().getPortName().equals("B") ? MOTOR_RIGHT : MOTOR_LEFT).toString() + ", ");
    ...
    public Void visitMotorStopAction(MotorStopAction<Void> motorStopAction) {
        ...
        this.sb.append((motorStopAction.getPort().getPortName().equals("B") ? MOTOR_RIGHT : MOTOR_LEFT).toString());
        this.sb.append(end);
        return null;
    }
    ...
    public Void visitEncoderSensor(EncoderSensor<Void> encoderSensor) {
        String encoderMotor = (encoderSensor.getPort().getPortName().equals("B") ? MOTOR_RIGHT : MOTOR_LEFT).toString();
